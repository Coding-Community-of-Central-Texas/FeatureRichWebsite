...
define('DB_USER', 'osccctor_oscl653');

// MySql database password
define('DB_PASSWORD', 'OS@pX74]5d');

// MySql database name
define('DB_NAME', 'osccctor_oscl653');

// MySql database table prefix
define('DB_TABLE_PREFIX', 'os3b_');

// Relative web url
define('REL_WEB_URL', '/home/ad_manage/');

// Web address - modify here for SSL version of site
define('WEB_PATH', 'https://osccct.org/home/ad_manage/');
